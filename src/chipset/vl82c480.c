                ...
                switch (dev->idx) {
                    ...
                    case 0x02: case 0x03:
                        ...
                        if ((machines[machine].init == machine_at_martin_init) ||
                            (machines[machine].init == machine_at_prolineamt_init) || (machines[machine].init == machine_at_prolinea466_init))
...
vl82c480_init(const device_t *info)
{
    ...
    uint8_t     min_i    = (machines[machine].init == machine_at_prolineamt_init) || (machines[machine].init == machine_at_prolinea466_init) ? 1 : 0;
    uint8_t     min_j    = (machines[machine].init == machine_at_prolineamt_init) || (machines[machine].init == machine_at_prolinea466_init) ? 4 : 2;
    uint8_t     max_j    = (machines[machine].init == machine_at_prolineamt_init) || (machines[machine].init == machine_at_prolinea466_init) ? 8 : 7;
    ...
    if ((machines[machine].init == machine_at_prolineamt_init) || (machines[machine].init == machine_at_prolinea466_init)) {
        dev->banks[0] = 4096;
