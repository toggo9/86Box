...
static const device_config_t d943_config[] = {
    // clang-format off
    {
        ...
        .spinner = { 0 }, /*W1*/
        .bios = {
            { .name = "Version 4.05 Revision 1.00.943 (02/21/1996)", .internal_name = "d943", .bios_type = BIOS_NORMAL,
              .files_no = 1, .local = 0, .size = 262144, .files = { "roms/machines/d943/d943.bin", "" } },
            ...
            { .name = "Version 4.05 Revision 1.07.943 (12/29/1998)", .internal_name = "d943_dec98", .bios_type = BIOS_NORMAL,
              .files_no = 1, .local = 0, .size = 262144, .files = { "roms/machines/d943/d943_dec98.bin", "" } },  
...
const device_t d943_device = {
    .name          = "Siemens-Nixdorf Scenic 5H/xxx PCI",
    .internal_name = "scenic5hxxx_pci",
    .flags         = 0,
    .local         = 0,
    .init          = NULL,
    .close         = NULL,
