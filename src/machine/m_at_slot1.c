...
int
machine_at_vl601_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/vl601/627ic14.rom",
                           0x000e0000, 131072, 0);
...
int
machine_at_vl603_init(const machine_t *model)
{
    int ret;

    ret = bios_load_linear("roms/machines/vl603/114iq126.bin",
                           0x000e0000, 131072, 0);
...
machine_at_s61_init(const machine_t *model)
{
    ...
    ret = bios_load_linear("roms/machines/s61/S6101F0.bin",
                           0x000c0000, 262144, 0);
